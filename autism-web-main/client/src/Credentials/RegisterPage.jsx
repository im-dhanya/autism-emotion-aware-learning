  ...
  <Suspense fallback={<div>Loading AI Module...</div>}>
    <Prediction />
        ...
        <section className="section-1">
          <h2>Welcome To <span> Autism Personalized Learning App! </span></h2>
        </section>
        <br/>
        ...
        <br/>
        <div className="link">Already Have An Account ? <Link className="link" onClick={()=>setPage("login")} >Login</Link></div>
        </section>
        </main> : 
        <main className="container-register">
         <section className="section-1">
        ...
        <br/>
        <div className="link"> New member? <Link className="link" onClick={()=>setPage("register")} >Register</Link></div>
        </section>
         </main>
        }
        </>
